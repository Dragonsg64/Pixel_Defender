...
text_fond = pg.font.SysFont("Consolas", 24, bold = True)
large_fond = pg.font.SysFont("Consolas", 36)
...
while run:
    ...
    draw_text(str(world.health), text_fond, "grey100", 0, 0)
    draw_text(str(world.money), text_fond, "grey100", 0, 30)
